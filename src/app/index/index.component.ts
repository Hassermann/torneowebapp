...
import { faUserNurse, faBookMedical, faUserInjured, faAddressBook, faBriefcaseMedical, faUserCog, faCalendarWeek, faCalendarCheck, faUserPlus,faCalendarPlus, faBriefcase, faSignOutAlt, faFunnelDollar, faDollarSign } from '@fortawesome/free-solid-svg-icons';
...
export class IndexComponent implements OnInit {
  ...
  botonGestionPago(){
    this.router.navigateByUrl("/consultapago");
  }
